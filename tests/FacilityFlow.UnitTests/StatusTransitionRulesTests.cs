...
{
    [Theory]
    [InlineData(ServiceRequestStatus.Neu, ServiceRequestStatus.Zugewiesen)]
    [InlineData(ServiceRequestStatus.InBearbeitung, ServiceRequestStatus.Geloest)]
    [InlineData(ServiceRequestStatus.Geloest, ServiceRequestStatus.Geschlossen)]
    ...
    [InlineData(ServiceRequestStatus.Geschlossen, ServiceRequestStatus.InBearbeitung)]
